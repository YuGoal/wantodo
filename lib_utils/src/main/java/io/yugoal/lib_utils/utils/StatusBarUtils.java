...
public final class StatusBarUtils {
    ...
    public static void setNotificationBarVisibility(Activity activity, final boolean isVisible) {
        String methodName;
        if (isVisible) {
        ...
        invokePanels(activity, methodName);
    }

    private static void invokePanels(Activity activity, final String methodName) {
        try {
     ...
     * @param isVisible True to set navigation bar visible, false otherwise.
     */
    public static void setNavBarVisibility(@NonNull final Window window, Activity activity, boolean isVisible) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
     ...
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isNavBarVisible(Activity activity, @NonNull final Window window) {
    ...
    public static void setNavBarColor(@NonNull final Activity activity, @ColorInt final int color) {
        if (StatusBarUtils.isSupportNavBar(activity)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
