...
public class StringUtils {
     ...
     * @return
     */
    public static String hiddeCenterNumbe(String string) {
     ...
     * @return
     */
    public static String double2String(float d, int num) {
        if (Double.isNaN(d)) {
            return 0 + "";
        }
     ...
     * @return
     */
    public static String double2String(Float d, int num, String defValue) {
        if (d == null) {
            return defValue;
        }
     ...
     * @return
     */
    public static String getFenLever(float fen) {
        String fenlever = "";
        if (fen >= 8) { // 8-10
            fenlever = "优秀 I " + fen + "分";
        } else if (fen >= 5) { // 5-7分
