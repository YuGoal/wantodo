...
public class AndroidUtil {
     ...
     * @param srvName
     */
    public static void stopService(Context context, String srvName, String pagName) {

        if (isServiceExisted(context, srvName)) {
            Intent intent = new Intent();
            // ComponentName的参数1:目标app的包名,参数2:目标app的Service完整类名
            intent.setComponent(new ComponentName(pagName,
                    srvName));
     ...
     * @return
     */
    public static boolean isRun(Context context, String pageName) {
        ActivityManager am = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningTaskInfo> list = am.getRunningTasks(100);
        boolean isAppRunning = false;
        String MY_PKG_NAME = pageName;
     ...
     * @param activity
     */
    public static void openSPGAppSetting(Activity activity) {
        //跳转到手机原生设置页面
     ...
     * @param url
     */
    public static void openChorm(Activity activity, String url) {
        Intent intent = new Intent();
     ...
     * @param activity
     */
    public static void openWeix(Activity activity) {
        String url = "weixin://";
