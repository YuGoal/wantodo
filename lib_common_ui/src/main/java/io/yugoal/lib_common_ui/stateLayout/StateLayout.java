package io.yugoal.lib_common_ui.stateLayout;
...
/**
 * 加载成功、加载失败、加载中、无数据四个不同界面的切换
 * Created by caoyu on 2018/3/21/021.
 */
...
public class StateLayout extends FrameLayout {
    ...
    private void initView() {
        ...
        Button btnReload = (Button) emptyView.findViewById(R.id.click_again);
