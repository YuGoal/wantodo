 ...
 * time 17:56
 */
public class CharAvatarView extends androidx.appcompat.widget.AppCompatImageView {
    // 颜色画板集
    ...
    public CharAvatarView(@NonNull Context context) {
        super(context);
        init();
    }

    public CharAvatarView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CharAvatarView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
