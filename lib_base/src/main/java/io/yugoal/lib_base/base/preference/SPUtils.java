package io.yugoal.lib_base.base.preference;
...
public class SPUtils {
    ...
    private static class SPHolder {
        private static final SharedPreferences INSTANCE = PreferenceManager.getDefaultSharedPreferences(BaseApp.getContext());
    }
